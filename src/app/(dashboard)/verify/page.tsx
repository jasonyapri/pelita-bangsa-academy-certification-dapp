    ...
    <Stack spacing={3}>
      ...
      <Card sx={{ p: 2 }}>
        <ButtonGroup variant="outlined" aria-label="Basic button group">
          ...
          />
          <LoadingButton sx={{ p: 2 }} loading={isLoading} loadingPosition="start" variant="contained" startIcon={(<MagnifyingGlassIcon />)} onClick={searchCertificateById} disabled={certificateId == lastTriggeredCertificateId}>
            Verify
          </LoadingButton>
        </ButtonGroup>
        {/* <>
